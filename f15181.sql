...
--   Date and Time:   19:49 Thursday March 17, 2016
--   Exported By:     JEFF
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20160317194840'
...
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160317183333'
);
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JEFF'
,p_last_upd_yyyymmddhh24miss=>'20160317194729'
);
wwv_flow_api.create_page_plug(
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select c003 as lat, c004 as lng, c002 as name, c001 as id, c002 || '' (id='' || c001 || '')'' as info, '''' as icon, c005 as radius_km',
'from apex_collections',
'where collection_name = ''MAP'''))
,p_plug_source_type=>'PLUGIN_COM.JK64.REPORT_GOOGLE_MAP'
,p_plug_query_row_template=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(75350532292304902)
,p_query_column_id=>5
,p_column_alias=>'INFO'
,p_column_display_sequence=>5
,p_column_heading=>'Info'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(70144812270519519)
,p_query_column_id=>6
,p_column_alias=>'ICON'
...
'Query for map plugin:',
'<code>',
'select c003 as lat, c004 as lng, c002 as name, c001 as id, c002 || '' (id='' || c001 || '')'' as info, '''' as icon, c005 as radius_km, ''#cc0000'' as color, ''0.1'' as transparency',
'from apex_collections',
'where collection_name = ''MAP''',
'</code>'))
,p_plug_query_row_template=>1
